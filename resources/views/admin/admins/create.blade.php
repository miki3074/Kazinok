            ...
            <div class="row gap-20 masonry pos-r">
                ...
                <div class="masonry-item col-md-6">
                    <div class="bgc-white p-20 bd">
                        <h6 class="c-grey-900">Создать админа</h6>
                        <div class="mT-30">
                            <form action="/admin/admins/create" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                </div>
