                    ...
                    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                            <ul class="kt-menu__nav ">
                                ...
                                <li class="kt-menu__item {{ Request::is('admin/refovods*') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                    <a href="{{ route('admin.refovods') }}" class="kt-menu__link">
                                        <span class="kt-menu__link-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <span class="kt-menu__link-text">Топ рефоводов</span>
                                    </a>
                                </li>
                                @endif
                                @if($u->is_admin || $u->is_promocoder)
                                <li class="kt-menu__item {{ Request::is('admin/promocodes*') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                ...
                                <li class="kt-menu__item {{ Request::is('admin/deposits') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                ...
                                <li class="kt-menu__item {{ Request::is('admin/allwithdraws') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                    <a href="{{ route('admin.fullwithdraws') }}" class="kt-menu__link">
                                        <span class="kt-menu__link-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect id="bound" x="0" y="0" width="24" height="24"/>
                                        ...
                                        <span class="kt-menu__link-text">Все выводы</span>
                                    </a>
                                </li>
                                @if($u->is_admin)
                                <li class="kt-menu__item {{ Request::is('admin/logs') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                    <a href="{{ route('admin.adminlogs') }}" class="kt-menu__link">
                                        <span class="kt-menu__link-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect id="bound" x="0" y="0" width="24" height="24"/>
                                        ...
                                        <span class="kt-menu__link-text">Логи админки</span>
                                    </a>
                                </li>
                                @endif
                                <li class="kt-menu__section ">
                                    <h4 class="kt-menu__section-text">Настройка слотов</h4>
                                    <i class="kt-menu__section-icon flaticon-more-v2"></i>
                                </li>
                                <li class="kt-menu__item {{ Request::is('admin/slots*') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                    <a href="/admin/slots" class="kt-menu__link">
                                        <span class="kt-menu__link-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect id="bound" x="0" y="0" width="24" height="24"/>
                                        ...
                                        <span class="kt-menu__link-text">Список слотов</span>
                                    </a>
                                </li>
                                @endif
                            </ul>
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                    ...
                    <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                        <div class="kt-footer__copyright">
                            2022 © Сайт доработан студией&nbsp;<a href="#" target="_blank" class="kt-link">Clutcher</a>
                        </div>
                    </div>
